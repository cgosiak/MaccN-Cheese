/*	____________________________________________________________________________
	           ...
	           Semantics and Coding Component for the MicroA Compiler
	               ...
	               Update by Jeff Arthur: January 28th, 2016
...
*/
	...
	void WriteString();
	// Produces the assembly code for writting a string.
...
private:
	...
	int strSum;		  // variable to keep track of offset

	int  maxTemp;     // max temporary allocated so far; initially 0
	
	int strSize(const string fsize);
